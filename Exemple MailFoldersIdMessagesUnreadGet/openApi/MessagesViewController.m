...
- (void)cargarMessages
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/%@/messages/unread?access_token=%@", self.folder.identifier, self.auth.accessToken]];
