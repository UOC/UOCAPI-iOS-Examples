...
- (void)viewDidAppear:(BOOL)animated
{
    if (self.loadedAuth == 1) {
        ProfilesViewController *profilesViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"profilesView"];
        profilesViewController.auth = self.auth;
