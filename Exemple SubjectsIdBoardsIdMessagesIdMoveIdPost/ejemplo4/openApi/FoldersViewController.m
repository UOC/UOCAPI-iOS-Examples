...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/boards/%@/messages/%@/move/%@?access_token=%@", self.aula.identifier, self.board.identifier , self.message.identifier , folder.identifier , self.auth.accessToken]];
