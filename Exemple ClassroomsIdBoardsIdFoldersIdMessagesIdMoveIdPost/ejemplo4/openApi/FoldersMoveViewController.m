...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/folders/%@/messages/%@/move/%@?access_token=%@", self.aula.identifier, self.board.identifier ,self.oriFolder.identifier , self.mail.identifier , folder.identifier , self.auth.accessToken]];
