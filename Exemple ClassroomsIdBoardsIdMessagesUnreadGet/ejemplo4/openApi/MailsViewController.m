...
- (void)cargarMails
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/messages/unread?access_token=%@",self.aula.identifier, self.tauler.identifier, self.auth.accessToken]];
