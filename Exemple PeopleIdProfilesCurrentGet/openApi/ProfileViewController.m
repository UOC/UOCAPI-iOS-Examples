...
- (void)cargarPerfil
{
    ...
    NSURL *profilesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/people/%@/profiles/current?access_token=%@", self.person.identifier, self.auth.accessToken]];
