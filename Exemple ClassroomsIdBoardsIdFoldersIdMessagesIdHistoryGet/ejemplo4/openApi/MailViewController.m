...
- (void)cargarMail
{
    ...
    NSURL *userURL = [NSURL URLWithString:
                      [NSString stringWithFormat:
                       @"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/folders/%@/messages/%@/history?access_token=%@", self.aula.identifier,self.board.identifier,self.folder.identifier, self.idMail ,self.auth.accessToken]];
