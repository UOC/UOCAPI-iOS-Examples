...
- (void) setDatos:(NSDictionary *)peopleDictionary
{
    ...
    //lastUpdate ens retorna un timestamp. Un timestamp es el temps en (ms) que ha passat desde
    // l'1 de gener de l'any 1970. Per aixo cal fer les seguents operacions.
