...
-(void) carregarFolder
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/boards/%@/folders/%@?access_token=%@", self.aula.identifier, self.board.identifier, self.idFolder, self.auth.accessToken]];
