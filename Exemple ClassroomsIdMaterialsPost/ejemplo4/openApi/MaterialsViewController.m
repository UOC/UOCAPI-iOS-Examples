...
-(IBAction)postMaterial
{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/materials?access_token=%@", self.aula.identifier, self.auth.accessToken]];
